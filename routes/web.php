...
Route::redirect('login', '/login/student');
...
Route::group([
    ...
    Route::get('/evaluationStudent/{id}', 'EvaluationController@showStudent');
    Route::get('/evaluationResponse/{id}', 'EvaluationController@showResponse');
});
