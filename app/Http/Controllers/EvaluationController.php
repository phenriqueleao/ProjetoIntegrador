...
class EvaluationController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $standardquestions = StandardQuestionnaireItem::orderBy('number', 'ASC')->get();
    ...
    public function showResponse($id)
    {
        ...
        $standardquestions = StandardQuestionnaireItem::orderBy('number', 'ASC')->get();
        $extraquestions = ExtraQuestionnaireItem::all();
        $students = Student::where('students.evaluation_id', '=', $id)->get();
        $responses = Response::where('responses.evaluation_id', '=', $id)->get();
        
        return view('evaluation.response', [
            'evaluation' => $evaluation,
            'standardquestions' => $standardquestions,
            'extraquestions' => $extraquestions,
            'students' => $students,
